...
namespace Grabacr07.KanColleWrapper
{
	partial class KanColleProxy
	{
		...
		{
			get { return this.ApiSessionSource.Where(x => x.PathAndQuery == "/kcsapi/api_req_hensei/preset_select"); }
		}
		...
		{
			get { return this.ApiSessionSource.Where(x => x.PathAndQuery == "/kcsapi/api_req_kaisou/slot_exchange_index"); }
		}
		...
		{
			get { return this.ApiSessionSource.Where(x => x.PathAndQuery == "/kcsapi/api_req_kaisou/slot_deprive"); }
		}
		...
		{
			get { return this.ApiSessionSource.Where(x => x.PathAndQuery == "/kcsapi/api_get_member/require_info"); }
		}
