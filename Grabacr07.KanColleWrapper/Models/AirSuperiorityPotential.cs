...
namespace Grabacr07.KanColleWrapper.Models
{
	...
	public static class AirSuperiorityPotential
	{
		...
		{
            public abstract AirSuperiorityCalculationOptions Options();
		...
		{
			public override AirSuperiorityCalculationOptions Options() {
                return AirSuperiorityCalculationOptions.Fighter;
            }
		...
		{
			public override AirSuperiorityCalculationOptions Options() {
                return AirSuperiorityCalculationOptions.Attacker;
            }
		...
		{
			public override AirSuperiorityCalculationOptions Options() {
                return AirSuperiorityCalculationOptions.SeaplaneBomber;
            }
		...
		{
			public static EmptyCalculator Instance = new EmptyCalculator();

			public override AirSuperiorityCalculationOptions Options() {
                return ~AirSuperiorityCalculationOptions.Default;
            }
		...
		private class Proficiency
		{
            ...
            public int SeaplaneBomberBonus;
        ...
        {
            return proficiencies[Math.Max(Math.Min(slotItem.Proficiency, 7), 0)];
        }
	}
}