...
namespace Grabacr07.KanColleWrapper.Models
{
	...
	public class Experience
	{
		...
		{
            return admiralTable.ContainsKey(currentLevel + 1) ? admiralTable[currentLevel + 1].Total - currentExperience : 0;
		}
		...
		public static int GetShipExpForSpecifiedLevel(int currentExperience, int targetLevel) {
            if (targetLevel != null && shipTable.ContainsKey(targetLevel)) {
                return shipTable[targetLevel].Total - currentExperience;
            } else {
                return 0;
            }
        }
